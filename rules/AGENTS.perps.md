...
# Auto Agent Rules — `perps` surface

Operating rules for an agent using Auto MCP with `AUTO_MCP_SURFACE=perps`. Paste this file into your harness's rules/system prompt
